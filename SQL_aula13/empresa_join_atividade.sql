...
-- Inner join
select dep.DEPNOME nome_departamento, func.FUNNOME nome_funcionario
from departamento dep
inner join funcionario func
on dep.DEPCODIGO = func.DEPCODIGO;
...
left join dependente depen
on func.FUNCODIGO = depen.FUNCODIGO
where depen.FUNCODIGO is null;

-- Right join
select func.FUNNOME nome_funcionario, depen.DEPENNOME nome_dependente
from funcionario func
right join dependente depen
on func.FUNCODIGO = depen.FUNCODIGO;

select dep.DEPNOME nome_departamento, func.FUNNOME nome_funcionario
from departamento dep
right join funcionario func
on dep.DEPCODIGO = func.DEPCODIGO;
